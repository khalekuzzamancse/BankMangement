...
public class AddVisitationWithImageViewModel extends AbstractFormViewModel {


    private static final Labels labels = new LabelsImpl();

    public AddVisitationWithImageViewModel() {
        super();
    }
...
// create Account object and set properties
            VisitationModelWithImage visitationModel =
                    new VisitationModelWithImage(accountNo, boxKey, signature,
                            attendeeSignature, asDeputy, description);
            System.out.println(visitationModel);
            Reposititory.addVisitationWithImage(visitationModel);
